...
<div class="prof-settings max-w-3xl" style="max-width: 48rem; margin: 0 auto;">
    ...
    <div class="bg-white border border-[#E5EAF3] p-6 mb-4" style="border-radius: var(--radius-card); margin-bottom: 1rem; background: white; border: 1px solid #E5EAF3; padding: 1.5rem;">
        <div class="flex items-center gap-3 mb-5" style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1.25rem;">
            ...
            <div>
                ...
                <p class="text-navy/45 text-[12px]" style="color: rgba(16,55,92,0.45); font-size: 12px; margin: 0.125rem 0 0 0;">Thông tin tài khoản Business Manager</p>
            </div>
        </div>
        ...
        <div class="flex items-center gap-4 mb-5 p-4 bg-alice" style="display: flex; align-items: center; gap: 1rem; padding: 1rem; background: var(--alice); border-radius: calc(var(--radius-btn) - 2px); margin-bottom: 1.25rem;">
            <div id="avatarInitial" class="w-14 h-14 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-700 flex items-center justify-center text-white text-[20px] font-bold flex-shrink-0" style="width: 3.5rem; height: 3.5rem; border-radius: 50%; background: linear-gradient(135deg, #34d399, #059669); display: flex; align-items: center; justify-content: center; color: white; font-size: 20px; font-weight: 700; flex-shrink: 0;">
            </div>
            <div class="flex-1" style="flex: 1;">
                <div class="flex items-center gap-2" style="display: flex; align-items: center; gap: 0.5rem;">
                    ...
                    <span class="flex items-center gap-1 px-2 py-0.5 bg-emerald-50 text-emerald-700 text-[10px] font-semibold" style="display: inline-flex; align-items: center; gap: 0.25rem; padding: 0.125rem 0.5rem; background: #ecfdf5; color: #059669; font-size: 10px; font-weight: 600; border-radius: 20px; border: 1px solid rgba(5,150,105,0.1);">
                ...
                <div class="text-navy/50 text-[12px]" style="color: rgba(16,55,92,0.50); font-size: 12px; margin-top: 0.125rem;">Quản lý kinh doanh</div>
            </div>
        </div>

        <form id="personalInfoForm" class="space-y-4" style="display: flex; flex-direction: column; gap: 1rem;">
            <div>
                ...
                <div class="relative" style="position: relative;">
                    ...
                    <input
                        ...
                        readonly
                        class="w-full pl-10 pr-4 py-2.5 bg-[#F3F5F8] border border-[#E5EAF3] text-navy/50 text-[13px] cursor-not-allowed"
                        style="width: 100%; padding: 0.625rem 1rem 0.625rem 2.5rem; background: #f3f5f8; border: 1px solid #E5EAF3; color: rgba(16,55,92,0.50); font-size: 13px; outline: none; border-radius: calc(var(--radius-btn) - 2px); cursor: not-allowed;"
                    />
                </div>
                <p class="text-navy/40 text-[11px] mt-1" style="color: rgba(16,55,92,0.40); font-size: 11px; margin-top: 0.25rem;">Tên đăng nhập không thể thay đổi.</p>
            </div>
    ...
    <div class="bg-white border border-[#E5EAF3] p-6 mb-4" style="border-radius: var(--radius-card); background: white; border: 1px solid #E5EAF3; padding: 1.5rem; margin-bottom: 1rem;">
        ...
        <form id="passwordForm" class="space-y-4" style="display: flex; flex-direction: column; gap: 1rem;">
            ...
            <div class="p-3 bg-alice" style="padding: 0.75rem; background: var(--alice); border-radius: calc(var(--radius-btn) - 2px);">
                <p class="text-navy/50 text-[11px] font-semibold mb-1" style="color: rgba(16,55,92,0.50); font-size: 11px; font-weight: 600; margin: 0 0 0.25rem 0;">Yêu cầu mật khẩu:</p>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("saveProfileBtn").addEventListener("click", function () {
        ...
        fetch("${pageContext.request.contextPath}/business/profile", {
            method: "POST",
            headers: {
    ...
    document.getElementById("savePasswordBtn").addEventListener("click", function () {
        ...
        if (!hasUpper || !hasLower || !hasDigit || !hasSpec) {
            showToast("Mật khẩu không đáp ứng đầy đủ yêu cầu bảo mật", true);
            return;
        }
