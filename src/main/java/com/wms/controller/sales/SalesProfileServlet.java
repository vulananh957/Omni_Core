...
/**
 * SalesProfileServlet — Handles Account Settings (Cài đặt tài khoản) for Sales Staff.
 *
 * Maps to /sales/profile.
 */
public class SalesProfileServlet extends BaseController {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.setAttribute("currentPage",  "sales-profile");

        // Set the body content page fragment
        req.setAttribute("contentPage", "/WEB-INF/views/sales/sales-profile.jsp");
