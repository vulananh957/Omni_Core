...
public class ChannelDAO {
    ...
    public boolean insert(Channel channel) {
        String sql = "INSERT INTO channels (channel_name, platform, api_url, api_key, app_secret, webhook_secret, buffer_stock, is_active, access_token, refresh_token) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (Connection conn = DBConnection.getConnection();
            ...
            ps.setDouble(7, channel.getBufferStock());
            ps.setInt(8, channel.isActive() ? 1 : 0);
            ps.setString(9, channel.getAccessToken());
            ps.setString(10, channel.getRefreshToken());
    ...
    public boolean update(Channel channel) {
        String sql = "UPDATE channels SET "
                ...
                + "app_secret = ?, webhook_secret = ?, buffer_stock = ?, is_active = ?, "
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            ps.setString(9, channel.getAccessToken());
            ps.setString(10, channel.getRefreshToken());
            ps.setInt(11, channel.getChannelId());
