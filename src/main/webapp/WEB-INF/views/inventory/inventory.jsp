        ...
        <table class="wms-table">
            <thead>
                <tr>
                    ...
                    <th style="text-align: right;" title="Tồn vật lý (đếm được trên kệ)">Tồn VT<br><span style="font-weight:400;font-size:10px">On-Hand</span></th>
                    <th style="text-align: right;" title="Đã phân bổ cho đơn đang xử lý">Tạm giữ<br><span style="font-weight:400;font-size:10px">Reserved</span></th>
                    <th style="text-align: right; font-weight:700;" title="On-Hand − Reserved — con số thực sự được bán">Khả dụng<br><span style="font-weight:400;font-size:10px">Available ★</span></th>
                    <th style="text-align: right;" title="Hàng đang về (PO đã duyệt, chờ nhận)">Nhập về<br><span style="font-weight:400;font-size:10px">Inbound</span></th>
