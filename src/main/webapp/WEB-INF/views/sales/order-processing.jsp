...
.op-label-marker { text-align: center; font-size: 9px; font-weight: 900; color: rgba(16,55,92,.3); border-top: 1px solid rgba(16,55,92,.1); padding-top: 0.5rem; margin-top: auto; }
